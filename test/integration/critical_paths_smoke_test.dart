...
void main() {
  ...
  group('critical flow smoke', () {
    test(
      'startup route boot path stays healthy',
      () {
    ...
    test(
      'playback start/stop transitions execute deterministically',
      () async {
    ...
    test(
      'startup restore reconciliation contract flags offline safely',
      () {
        const StartupResult offlineRestore = StartupResult.degraded(
          'IAP service degraded.',
        );
